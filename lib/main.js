...
const DOCK_BUTTONS = [
  {
    ...
    title: () => `Left dock is ${atom.workspace.getLeftDock().isVisible() ? "open" : "closed"}`,
  },
  {
    icon: ICONS.bottom,
    iconOpen: ICONS.bottomOpen,
    command: "quick-layout:toggle-bottom-dock",
    title: () => `Bottom dock is ${atom.workspace.getBottomDock().isVisible() ? "open" : "closed"}`,
  },
  {
    icon: ICONS.right,
    iconOpen: ICONS.rightOpen,
    command: "quick-layout:toggle-right-dock",
    title: () => `Right dock is ${atom.workspace.getRightDock().isVisible() ? "open" : "closed"}`,
  },
];
